...
public interface AssistantService {
     ...
     * @return
     */
    String insertAssistant(Assistant assistant);
     ...
     * @return
     */
    String updateAssistantByWorkId(Assistant assistant);
     ...
     * @return
     */
    String updateAssistantByWorkId(Assistant originalAssistant, Assistant newAssistant);
     ...
     * @return
     */
    String insertAndUpdateAssistantsFromExcel(List<Assistant> assistants) throws Exception;
     ...
     * @return
     */
    String insertAndUpdateOneAssistantFromExcel(Assistant assistant) throws Exception;
     ...
     * @return
     */
    void deleteOneAssistantById(Long id);
