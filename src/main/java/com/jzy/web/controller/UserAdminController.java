...
public class UserAdminController extends AbstractController{
    ...
    public String stuEdit(Model model, User user) {
        /**
    ...
    @ResponseBody
    public ResultMap<List<User>> showAllStuInfo(MyPage myPage, UserSearchCondition condition) {
        PageInfo<User> pageInfo = userService.listUsers(myPage, condition);//从数据库中获取查询所需的数据，在此之前，你不需要在sql语句中编写分页语句，该插件会在查询时直接将分页语句添加到数据库后
    ...
    @ResponseBody
    public Map<String, Object> deleteOneStudent(Long id, String userRole) {
        Map<String, Object> map = new HashMap();
        /**
         * 根据角色设置，当前角色可以编辑的角色权限。如，学管只能修改用户角色为[学管, 助教长, 助教，教师，游客]，不能设成管理员;
         *      而管理员可以修改用户角色为[管理员，学管, 助教长, 助教，教师，游客]
    ...
    @ResponseBody
    public Map<String, Object> deleteManyStudents(@RequestParam("users") String users) {
        Map<String, Object> map = new HashMap();
        /**
         * 根据角色设置，当前角色可以编辑的角色权限。如，学管只能修改用户角色为[学管, 助教长, 助教，教师，游客]，不能设成管理员;
         *      而管理员可以修改用户角色为[管理员，学管, 助教长, 助教，教师，游客]
