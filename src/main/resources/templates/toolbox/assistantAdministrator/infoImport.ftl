                    ...
                    <ul class="layui-timeline">
                        <li class="layui-timeline-item">
                            ...
                            <div class="layui-timeline-content layui-text">
                                ...
                                <p>常见场景:</p>
                                <ul>
                                    <li>场景1：春季马上要开课了，校区新招了一些助教，新的学生明代和排班表都已经有了。执行：STEP1 -> STEP2 -> STEP3 -> STEP4</li>
                                    ...
                                    <li>场景4：春季已经开课几周了，最近有一些班级的上课教师和任课教师有变动，即只有排班信息变了。执行：STEP2</li>
                                    <li>场景5：春季已经开课几周了，最近有一些新学生进班还有一些转班地，但助教没有人员变动，即只有学生和学生上课信息变了。执行：STEP3</
                                    </li>
                                </ul>
                            </div>
                        </li>
